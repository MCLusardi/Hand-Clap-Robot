...
Took this code from MP-PyTorch `demo_prodmp.py` here: https://github.com/ALRhub/MP_PyTorch/blob/main/mp_pytorch/demo/demo_prodmp.py
"""
...
def test_prodmp():
    ...
    # Comment this line out if I create custom configs
